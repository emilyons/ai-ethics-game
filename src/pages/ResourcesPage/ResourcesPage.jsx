  ...
  const resources = [
    {
      ...
      description:
        "Research highlighting the importance of considering children in AI ethics discussions.",
    },
    {
      title:
      ...
      description:
        "A curriculum guide for teaching AI ethics to middle school students.",
    },
    {
      title: "Explainable Artificial Intelligence for Kids",
      url: "https://www.atlantis-press.com/proceedings/eusflat-19/125914791",
      description:
        "A resource for making AI concepts understandable for children.",
    },
    {
      title:
    ...
    },
    {
      ...
      description:
        "An analysis of different AI ethics curricula for middle school students.",
    },
  ];
  return (
    <main className="resources">
      <div className="resources__container">
        <h1 className="resources__title">AI Ethics Resources</h1>
        <p className="resources__description">
          Explore these resources to learn more about AI ethics and responsible
          AI development.
        </p>
        <ul className="resources__list">
          {resources.map((resource, index) => (
            <li key={index} className="resources__item">
              ...
              <p className="resources__item-description">
        ...
        <div className="resources__more-info">
          ...
          <p>
            Check out our{" "}
            <a href="/full-resource-list">complete list of resources</a> for
            more in-depth information on AI ethics education.
          </p>
        </div>
      </div>
    </main>
